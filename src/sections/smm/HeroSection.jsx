...
export default function HeroSection({ scrollY }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black pt-32 md:pt-24">
      ...
      <motion.div
        className="absolute -top-10 -right-10 w-[300px] h-[300px] bg-teal/20 rounded-full blur-[100px] mix-blend-lighten pointer-events-none"
        animate={{
      ...
      />
      <motion.div
        className="absolute -bottom-10 -left-10 w-[300px] h-[300px] bg-gold/15 rounded-full blur-[100px] mix-blend-lighten pointer-events-none"
        animate={{
          y: [-parallax * 0.4, -parallax * 0.4 + 20, -parallax * 0.4],
          scale: [1, 1.15, 1],
        }}
      ...
      <motion.div
        className="relative z-10 px-4 sm:px-6 max-w-4xl mx-auto text-center overflow-hidden"
        variants={container}
        initial="hidden"
        animate="visible"
      >
